export const siteConfig = {
  ...
  aboutMeHtml: "I'm a builder at heart, a self-taught developer who has been writing code since age 8 and keeps coming back to one question: what can I build that creates real impact? At Tesla STEM High School, I represented my school in state-level competitions at <a href=\"https://www.washingtontsa.org/\" target=\"_blank\" rel=\"noopener noreferrer\">Washington TSA</a> and won at <a href=\"https://wafbla.org/\" target=\"_blank\" rel=\"noopener noreferrer\">Washington FBLA</a>, getting a chance to compete at the national level; applying software engineering, design, and leadership under real competitive pressure. Whether I'm building AI-powered tools, full-stack applications, or Unity games with complex systems, I focus on turning ambitious ideas into polished, useful products.",
